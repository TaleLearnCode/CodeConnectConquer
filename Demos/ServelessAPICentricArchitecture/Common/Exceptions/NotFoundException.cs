...
/// <summary>
/// Represents an exception that is thrown when a specified document cannot be located.
/// </summary>
public class NotFoundException : Exception
{
	...
	/// </summary>
	public NotFoundException() : base("Failed to locate the specified document.") { }
